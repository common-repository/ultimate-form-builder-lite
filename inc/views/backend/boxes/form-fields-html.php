<div class="ufbl-form-fields-reference" style="display:none;">
			...
			<div class="ufbl-field-settings-wrap" style="display:none;">
				...
				<div class="ufbl-form-field-wrap ufbl-full-width ufbl-op-wrap">
					...
					<div class="ufbl-form-field">
						...
						<div class="ufbl-option-value-wrap" style="display: none;">
							<div class="ufbl-each-option">
								<span class="ufbl-option-drag-arrow"><i class="fa fa-arrows"></i></span>
								<input type="text" name="field_data[ufbl_key][option][]" value="reference_dropdown" placeholder="Option" data-field-name="ufbl_key" data-field-type="option"/>
								<input type="text" name="field_data[ufbl_key][value][]" value="<reference_dropdown" placeholder="Value" data-field-name="ufbl_key" data-field-type="value"/>
	...
	<div class="ufbl-radio-reference">
		<div class="ufbl-each-form-field ufbl-relative">
			...
			<div class="ufbl-field-settings-wrap" >
				<span class="ufbl-up-arrow"></span>
				<div class="ufbl-form-field-wrap">
					<label><?php _e( 'Field Label', 'ultimate-form-builder-lite' ); ?></label>
					<div class="ufbl-form-field">
				...
				<div class="ufbl-form-field-wrap ufbl-full-width ufbl-op-wrap">
					...
					<div class="ufbl-form-field">
						...
						<div class="ufbl-option-value-wrap">
							<div class="ufbl-each-option " style="display: none;">
								<span class="ufbl-option-drag-arrow"><i class="fa fa-arrows"></i></span>
								<input type="text" name="field_data[ufbl_key][option][]" value="reference_radio" placeholder="Option" data-field-name="ufbl_key" data-field-type="field_label"/>
								<input type="text" name="field_data[ufbl_key][value][]" value="reference_radio" placeholder="Value" data-field-name="ufbl_key" data-field-type="field_label"/>
								<span class="ufbl-option-remover">X</span>
							</div>
							<div class="ufbl-each-option">
								<span class="ufbl-option-drag-arrow"><i class="fa fa-arrows"></i></span>
				...
				<div class="ufbl-form-field-wrap ufbl-full-width ufbl-op-wrap">
					...
					<div class="ufbl-form-field">
						...
						<div class="ufbl-option-value-wrap">
							<div class="ufbl-each-option" style="display: none;">
								<span class="ufbl-option-drag-arrow"><i class="fa fa-arrows"></i></span>
								<input type="text" name="field_data[ufbl_key][option][]" value="reference_checkbox" placeholder="Option" data-field-name="ufbl_key" data-field-type="field_label"/>
								<input type="text" name="field_data[ufbl_key][value][]" value="reference_checkbox" placeholder="Value" data-field-name="ufbl_key" data-field-type="field_label"/>
								<span class="ufbl-option-remover">X</span>
							</div>
							<div class="ufbl-each-option">
								<span class="ufbl-option-drag-arrow"><i class="fa fa-arrows"></i></span>
